...
# %%
def d3heatmap(df, clust=None, path=None, title='Co-occurrence heatmap', description=None, scale=False, vmin=None, vmax=None, width=720, height=720, showfig=True, stroke='red', verbose=3):
